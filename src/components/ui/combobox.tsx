    ...
    <div className="relative" ref={containerRef}>
      <div className="relative">
        <input
          ...
          className="w-full min-w-[160px] rounded border border-black bg-[#ffffff] p-2 pr-8 text-black focus:border-white focus:outline-none"
        />
        ...
        {value && (
          <button
            type="button"
            onClick={handleClear}
            className="absolute top-1/2 right-2 -translate-y-1/2 text-white hover:text-white/80"
          >
            ✕
          </button>
        )}
